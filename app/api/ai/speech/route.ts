...
function buildSpeechInstruction(options: {
  ...
  return [
    ...
    "Se a função for CTA, incentive a compra usando carrinho: veja no carrinho, entra no carrinho, confere no carrinho, escolha no carrinho.",
    ...
    "Transforme características em benefícios percebidos pela cliente: tecido vira sensação no corpo, caimento vira como veste, praticidade vira segurança no uso real.",
    "A fala deve parecer uma vendedora experiente conversando na loja: humana, profissional, confiante e comercial sem parecer propaganda forçada.",
    "Evite frases genéricas como perfeito para qualquer ocasião, eleve seu estilo a outro patamar, peça indispensável, você vai amar ou você já imaginou.",
    "Evite palavras artificiais ou repetidas demais como silhueta, transformar seu look, arrasar, maravilhoso e incrível.",
